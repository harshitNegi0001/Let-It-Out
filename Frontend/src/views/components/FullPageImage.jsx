...
function FullPageImage({ images = [], setShowFullImage }) {
        ...
        <>
            <Box width={'100%'} height={'100%'} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }} position={'relative'} >
                ...
                </Box>
                {
                    ...
                    <Box sx={{display:'flex',justifyContent:'center',maxWidth:'90%',maxHeight:'90%',aspectRatio:1}} onClick={(e)=>e.stopPropagation()}>
