...
export default function Bookmarked({ userData }) {
    ...
    const getPosts = async () => {
        ...
        try {
            setIsLoading(true);
            const result = await axios.get(`${backend_url}/api/post/profile?userId=${userData.id}&&limit=${10}&&currPage=${currPage}&&reqType=${'saved_posts'}`,
                {
