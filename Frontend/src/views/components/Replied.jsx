...
export default function Replies({ userData, scrollRef }) {
    ...
    const getPosts = async () => {
        ...
        try {
            ...
            const url = (lastFeedId) ?
                `${backend_url}/api/post/profile?userId=${userData.id}&&limit=${10}&&lastFeedId=${lastFeedId}&&reqType=${'replied_post'}`
                :
                `${backend_url}/api/post/profile?userId=${userData.id}&&limit=${10}&&reqType=${'replied_post'}`
